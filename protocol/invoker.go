...
//go:generate mockgen -source invoker.go -destination mock/mock_invoker.go -self_package github.com/xd-luqiang/dubbo-go/v3/protocol/mock --package mock Invoker
// Extension - Invoker
