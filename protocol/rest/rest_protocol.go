...
import (
	...
	_ "github.com/xd-luqiang/dubbo-go/v3/protocol/rest/client/client_impl"
	rest_config "github.com/xd-luqiang/dubbo-go/v3/protocol/rest/config"
	_ "github.com/xd-luqiang/dubbo-go/v3/protocol/rest/config/reader"
	"github.com/xd-luqiang/dubbo-go/v3/protocol/rest/server"
	_ "github.com/xd-luqiang/dubbo-go/v3/protocol/rest/server/server_impl"
)
